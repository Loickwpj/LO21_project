...
public:
    ...
    ///Constructor
    Note(int i, const QString t=(QString)"", QDate d_c=QDate::currentDate(), QDate d_lm=QDate::currentDate(), bool a=false): id(i), title(t), dateC(d_c), dateM(d_lm), archive(a){}
...
public :
    ...
    Article(int i, const QString t=(QString)"", QDate d_c=QDate::currentDate(), QDate d_lm=QDate::currentDate(), bool a=false, const QString txt=(QString)""): Note(i,t,d_c,d_lm,a), text(txt)/*, careTaker(new MementoA*[5]),nbMemento(0),nbMax(5)*/ {}
...
public:
    //Constructor
   Multimedia (int i, const QString t, QDate d_c, QDate d_lm, bool a, const QString& d, const QString& f) : Note(i,t,d_c,d_lm,a), description(d), image(f) {}
